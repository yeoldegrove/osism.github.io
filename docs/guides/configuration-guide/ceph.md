...
Then generate the required LVM2 devices with the `ceph-configure-lvm-volumes` play.
...
Add this content to the host vars of the correspondingnode. The existing `ceph_osd_devies` parameter is replaced.
