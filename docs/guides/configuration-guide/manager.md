...
It is recommended to use a stable release of OSISM. All available releases are listed in the
[release notes](https://osism.tech/docs/release-notes/). Always check there in advance and do
